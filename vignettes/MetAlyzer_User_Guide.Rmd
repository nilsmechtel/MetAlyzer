...
After the imputation, the lowest values is non-zero. The imputation can also performed for each metabolite separately (recommended), which we do not show for simplicity since some metabolites only show zero values. The imputed values are written into column "imp_Conc".
```{r}
