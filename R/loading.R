...
#' Get data range
#'
#' This function extracts rows and column indices to slice the full_sheet into metabolites, raw_data and meta_data
#' @param object MetAlyzer object
#' 
#' @return 
#' @export
...
#' Get metabolites
#'
#' This function extracts metabolites with their corresponding class from full_sheet into metabolites
#' @param object MetAlyzer object
#' 
#' @return 
#' @export
...
#'
#' This function assigns the background color of each cell in full_sheet to the corresponding quantification status
#' @param object MetAlyzer object
#' 
#' @return
#' @export
